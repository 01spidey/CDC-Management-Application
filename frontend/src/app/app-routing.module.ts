...
const routes: Routes = [
  ...
  {path:'director', component:DirectorDashboardComponent, canActivate : [AuthGuard]}, //canActivate:[AuthGuard]
  {path:'officer', component:OfficerDashboardComponent, canActivate : [AuthGuard]} //canActivate:[AuthGuard]
];
